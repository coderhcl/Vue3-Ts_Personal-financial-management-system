    ...
    <div class="content">
        ...
        <div class="handleBtn">
          ...
          >
            ...
            >
              ...
              <el-form-item label="内容" prop="content" class="edit">
      ...
      <el-table border :data="incomeTableData" stripe>
        <el-table-column
          ...
          width="60"
        ></el-table-column>
        <el-table-column prop="name" label="标题" align="center" width="200" />
        <el-table-column
          prop="content"
          label="内容"
          align="center"
