...
import { getInvestmentChartData } from "@/service/main/property/property"
...
export default defineComponent({
  setup() {
    ...
    const getChartData = async () => {
      const result = await getInvestmentChartData({ ...chartData.value })
      const options = {
        color: ["#1983DB", "#55bfc0", "#5fbf68", "#de6a66", "#ece269"],
        title: {
          text: "投资占比",
          subtext: `投资前 ${chartData.value.limitNum} 占比`,
          left: "center"
        },
        tooltip: {
          trigger: "item"
